  ...
  <div class="py-4 px-4 mx-auto max-w-screen-xl  lg:px-6">
    ...
    <form class="max-w-md mx-auto mb-8">   
        ...
        <div class="relative">
            ...
            <input type="search" id="search" class="block w-full p-3 ps-9 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand shadow-xs placeholder:text-body" placeholder="Search posts..." autofocus  name="search" autocomplete="off"/>
